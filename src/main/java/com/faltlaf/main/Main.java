...
import com.flatlaf.panels.CustomersPanel;
import com.flatlaf.panels.DashboardPanels;
import com.flatlaf.panels.ProductsPanel;
import com.flatlaf.panels.SalesPanel;
...
public class Main {
    ...
    private static JPanel contentCards;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            ...
            rootPanel.add(createContentCards(), BorderLayout.CENTER);
    ...
    private static JButton createMenuButton(String pageName) {
    ...
    private static JPanel createContentCards() {
        ...
        contentCards.setBackground(CONTENT_COLOR);

        contentCards.add(new DashboardPanels(), "Dashboard");
        contentCards.add(new ProductsPanel(), "Products");
        contentCards.add(new SalesPanel(), "Sales");
        contentCards.add(new CustomersPanel(), "Customers");

        return contentCards;
    }

    private static JPanel createPage(String message) {
        JPanel page = new JPanel(new BorderLayout());

        page.setBackground(CONTENT_COLOR);
